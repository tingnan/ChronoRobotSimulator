...
namespace chrono
{
    ...
    protected:
        ...
        // must be a sorted, monotonically increasing array or the results will blow up
    ...
    public:
        ...
        {
            return new ChFunction_Data(mTime, mData);
        }
        ...
        double Get_y(double t)
        {
            ...
            std::vector<double>::iterator itr = upper_bound(mTime.begin(), mTime.end(), t);
